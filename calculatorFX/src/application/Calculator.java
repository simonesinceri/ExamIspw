...
public class Calculator extends Application {
	...
	public void start(Stage primaryStage) {
		...
		constructInterface(primaryStage);
	}
	...
	private void constructInterface(Stage primaryStage) {
		...
		try {
			...
			btnLog.setMinSize(100, 75);
			tastiera.add(btnLog, 2, 3);
